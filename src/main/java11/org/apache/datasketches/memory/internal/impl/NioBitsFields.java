 ...
 */
public class NioBitsFields {
    public static final String COUNT_FIELD_NAME = "COUNT";
    public static final String RESERVED_MEMORY_FIELD_NAME = "RESERVED_MEMORY";
    public static final String TOTAL_CAPACITY_FIELD_NAME = "TOTAL_CAPACITY";
}
